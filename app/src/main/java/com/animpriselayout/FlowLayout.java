...
//            Collections.reverse(lineViews);
    ...
    private void setViews() {
        final ImageView imageView = (ImageView) LayoutInflater.from(context).inflate(R.layout.item_praise, this, false);
            Glide.with(context)
                    .load(allUrls.get(mPostion))
                    .placeholder(R.mipmap.ic_launcher)
                  //  .bitmapTransform(new CropCircleTransformation(context))
                    .into(imageView);
            AnimatorSet set = new AnimatorSet();
            ObjectAnimator scaleXAnim = ObjectAnimator.ofFloat(imageView, "scaleX", 0.2f, 1);
            scaleXAnim.setDuration(300);
            ObjectAnimator scaleYAnim = ObjectAnimator.ofFloat(imageView, "scaleY", 0.2f, 1);
